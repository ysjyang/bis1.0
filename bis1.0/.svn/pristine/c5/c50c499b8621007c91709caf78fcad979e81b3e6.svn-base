...
public class Bustype1104BO extends BustypeCommonBO{
	...
	public Map cancelSendDatas(String maintablecode, String subtablecode,
        ...
        String sql ="select * from "+cancelmaintablecode+" where "+this.parseInSql2("cardno", listmap) +" for update";
        ...
        sql ="delete from "+cancelmaintablecode+" where "+this.parseInSql2("cardno", listmap);
