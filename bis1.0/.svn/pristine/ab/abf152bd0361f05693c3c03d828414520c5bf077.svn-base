...
public class Bustype2101BO extends BustypeCommonBO{
	...
	public Map readDatas(String maintablecode, String subtablecode,
        ...
        if(datas.size()>0){
            ...
            sql = "update "+maintablecode+" t set t.bisreadstatus=1,t.bisreadtime='"+bisreadtime+"' where "
            		+ this.parseInSql4("cardno", "agencycode", datas);
            dao.update(sql);
        }
	...
	public Map replySlipDatas(String maintablecode, String subtablecode,
		 ...
		 Map rt = new HashMap();
	        ...
	        if(datas.size()>0){
	            ...
	            CommonDAO dao = (CommonDAO)ServiceFactory.getBean("bis.common.CommonDAO");
	            String insql = this.parseInSql4("cardno", "agencycode", datas);
	            ...
	            if(listmap.size()!=num){
	            	...
	            	for(int i=0;i<listmap.size();i++){
	                	...
	                	sql = "select * from "+maintablecode+" t where nvl(t.bisreadstatus,0)=1 and cardno='"+guid+"'";
...
//	            	throw new AppException("0018");
	            ...
	            String sql = "update "+maintablecode+" t set t.bisreplyslipstatus=1,t.bisreplysliptime='"+bisreplysliptime
	            				+"' where nvl(t.bisreadstatus,0)=1 and "+insql;
	            dao.update(sql);
	        }
	        rt.put("result", "SUCCESS");
	        return rt;
