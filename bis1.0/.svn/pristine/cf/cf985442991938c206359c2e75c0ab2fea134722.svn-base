...
/**
 * @ClassName: Bustype2002BO
 * @Description: Description of this class
 * @author <a href="mailto:huchuan@szlongtu.com">胡川</a>于 2016-5-23 下午7:40:31
 */

public class Bustype2002BO extends BustypeCommonBO {
    ...
    public Map cancelSendDatas(String maintablecode, String subtablecode, String cancelmaintablecode,
        ...
        // 组装数据，用于第二次取消发送，key-guid，value-canceltype
        List calclelist = new ArrayList();
        Map canceltypemap = new HashMap();
        for (int i = 0; i < listmap.size(); i++) {
        	canceltypemap.put(((Map)listmap.get(i)).get("guid"), ((Map)listmap.get(i)).get("canceltype"));
			calclelist.add(canceltypemap);
        ...
        String subsql ="select * from "+cancelsubtablecode+" where "+this.parseInSql3("mainguid","guid", listmap) +" for update";
        sublist = dao.queryForList(subsql);
