...
/**
 * @ClassName: Bustype1025BO
 * @Description: Description of this class
 * @author <a href="mailto:zhongyi@szlongtu.com">钟毅</a>于 2016-5-17 上午09:24:33
 */

public class Bustype1025BO extends BustypeCommonBO {
...
Map rt = new HashMap();
        ...
        for(int i=0;i<listmap.size();i++){
            ...
            rtmap.put("voucherno", m.get("voucherno"));
            rtlist.add(rtmap);
        }
        //重复数据校验
