...
/**
 * @ClassName: Bustype1008BO
 * @Description: Description of this class
 * @author <a href="mailto:zhongyi@szlongtu.com">钟毅</a>于 2016-5-17 上午09:21:25
 */

public class Bustype1008BO extends BustypeCommonBO {
    ...
    public Map sendDatas(String maintablecode, String subtablecode, List listmap) throws AppException {
        ...
        //数据重复校验
    	CheckData.comCheckRepeat(listmap, maintablecode, "voucherguid" , this.parseInSql2("voucherguid", listmap));
        //保存数据
...
//            		guid = (String) map.get("voucherguid");
//            		repeatlist.add(guid);
//            	}
//            	String repeatguid = "";
...
//            			throw new AppException("0014","发送的list中数据重复，重复的voucherguid为："+repeatguid);
//            		}
//            	}
...
//            		guid1 = (String) map1.get("voucherguid");
//            		sql = "select * from "+maintablecode+" where voucherguid='"+guid1+"'";
//            		repeatlist1 = dao.queryForList(sql);
//            		if(repeatlist1.size()!=0){
//            			throw new AppException("0014","发送的list中数据和数据库原有数据重复，重复的voucherguid为："+guid1);
//            		}
//            	}
//            }else{
