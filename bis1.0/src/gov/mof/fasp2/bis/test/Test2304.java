...
public class Test2304 {
	...
	private static void readMethod(IFasp2PayBankService service) {
        ...
        Map rt1 = service.readVou("1306","msxt","150000","2017",verifycode);
        m = service.login("admin", "123456");
        verifycode = (String)m.get("verifycode");
        Map rt2 = service.replySlipVou("1306","msxt","150000","2017",verifycode,(List)rt1.get("datas"));
	...
	private static void sendMethod(IFasp2PayBankService service) {
         ...
         map.put("voucherguid","111");
        list.add(map);
         Map rt1 = service.sendVou("2304","pay","1500","2017",verifycode,list);
