...
/**
 * @ClassName: Bustype1002BO
 * @Description: Description of this class
 * @author <a href="mailto:zhongyi@szlongtu.com">钟毅</a>于 2016-5-17 上午09:20:25
 */

public class Bustype1002BO extends BustypeCommonBO {
    ...
    public Map sendDatas(String maintablecode, String subtablecode, List listmap) throws AppException {
        ...
        try {
            ...
            e.printStackTrace();
//            if(e.getMessage()!=null && e.getMessage().indexOf("违反唯一约束")!=-1){ //违反唯一约束,重复插入导致
