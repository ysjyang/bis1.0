...
/**
 * @ClassName: Bustype1016BO
 * @Description: Description of this class
 * @author <a href="mailto:zhongyi@szlongtu.com">钟毅</a>于 2016-5-17 上午09:23:10
 */

public class Bustype1016BO extends BustypeCommonBO {
    ...
    public Map sendDatas(String maintablecode, String subtablecode, List listmap) throws AppException {
        ...
        for(int i=0;i<listmap.size();i++){
            ...
            //校验退款是否是有原凭证，并且退款金额小于原凭证金额
            voucherguid = m.get("voucherguid")+"";
            amt = m.get("amt")+"";
            maintablecode.toLowerCase();
            sql = "select * from "+maintablecode.replace("1016m", "1011m") +" where guid = '"+voucherguid+"'";
