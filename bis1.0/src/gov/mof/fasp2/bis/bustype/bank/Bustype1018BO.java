...
/**
 * @ClassName: Bustype1018BO
 * @Description: Description of this class
 * @author <a href="mailto:zhongyi@szlongtu.com">钟毅</a>于 2016-5-17 上午09:23:26
 */

public class Bustype1018BO extends BustypeCommonBO {
    ...
    public Map sendDatas(String maintablecode, String subtablecode, List listmap) throws AppException {
        ...
        //数据重复校验
    	CheckData.comCheckRepeat(listmap, maintablecode, "planguid" , this.parseInSql2("planguid", listmap));
        //保存数据
...
//            			throw new AppException("0014","发送的list中数据重复，重复的planguid为："+repeatguid);
//            		}
//            	}
...
//            		guid1 = (String) map1.get("planguid");
//            		sql = "select * from "+maintablecode+" where planguid='"+guid1+"'";
//            		repeatlist1 = dao.queryForList(sql);
//            		if(repeatlist1.size()!=0){
//            			throw new AppException("0014","发送的list中数据和数据库原有数据重复，重复的planguid为："+guid1);
//            		}
//            	}
//            }else{
