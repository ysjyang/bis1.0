...
<html>
  <head>
	...
	<script type="text/javascript" src="/ltext/datatable3.0.js"></script>
	<script type="text/javascript" src="/js/jquery.js"></script>
	<script type="text/javascript" src="/js/common.js"></script>
	<script type="text/javascript" src="/cache/refreshCache.js"></script>
  </head>
  <body>
  <div class="bule_style">
      <div class="sysHead">
    	<div class="sys_logo"><a href="#">银行接口服务</a><span>缓存管理</span></div>
